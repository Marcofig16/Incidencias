...
export const renderTablaClientes = async (dashboardContent) => {
  ...
  const esAdministrador = window.usuarioActual && window.usuarioActual.rol === "administrador";
  ...
  // Botón para regresar al panel de administración (solo para administradores)
  if (btnVolverPanel) {
